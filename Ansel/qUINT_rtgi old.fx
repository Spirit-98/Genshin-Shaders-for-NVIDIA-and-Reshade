...
texture ZTex                    { Width = BUFFER_WIDTH>>1;    Height = BUFFER_HEIGHT>>1;   Format = R16F;         MipLevels = 1 + MIP_AMT; };
texture ColorTex                { Width = BUFFER_WIDTH>>1;    Height = BUFFER_HEIGHT>>1;   Format = RGBA16F;      MipLevels = 1 + MIP_AMT; };
#else 
#define MIP_AMT 	(LOG2(BUFFER_WIDTH) - 7)
...
#if SMOOTHNORMALS != 0
#if HALFRES_INPUT != 0 
pass{ VertexShader = VS_RT; PixelShader = PS_InputSetupHalfGbuf;RenderTarget0 = GITexFilter0;                                                                                  } 
pass{ VertexShader = VS_RT; PixelShader = PS_InputSetupHalfZCol;RenderTarget0 = ColorTex;    RenderTarget1 = ZTex;                                                             } 
#else 
pass{ VertexShader = VS_RT; PixelShader = PS_InputSetupFull;    RenderTarget0 = ColorTex;    RenderTarget1 = ZTex;      RenderTarget2 = GITexFilter0;                          } 
#endif 
